...
void printHeader() {
    cout << "========================================\n";
    cout << "  Carbon Emission Analysis - Linked List\n";
    cout << "========================================\n";
}
    ...
    while (true) {
        ...
        switch (choice) {
            case 'A':
                ...
                cout << "\nCity A analysis\n";
                cout << "----------------------------------------\n";
                compileAndRun("DatasetA", "main_linkedlist.cpp", "cityA_list");
                pressEnter();
                break;
            ...
            case 'B':
                ...
                cout << "\nCity B analysis\n";
                cout << "----------------------------------------\n";
                compileAndRun("DatasetB", "main_linkedlist.cpp residentList.cpp", "cityB_list");
                pressEnter();
                break;
            ...
            case 'C':
                ...
                cout << "\nCity C analysis\n";
                cout << "----------------------------------------\n";
                compileAndRun("DatasetC", "main_linkedlist.cpp list_methods.cpp array_methods.cpp", "cityC_list");
                pressEnter();
                break;
